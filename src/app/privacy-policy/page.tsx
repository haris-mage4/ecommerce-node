    ...
    <div className="pt-28 pb-20 px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-4xl font-light tracking-wider text-white">Privacy Policy</h1>
          <div className="w-12 h-px bg-white/20 mx-auto mt-6" />
        </div>

        <div className="space-y-10 text-white/50 text-sm leading-relaxed">
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Data Protection</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">WhatsApp Communication</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Contact Us</h2>
            <p>
