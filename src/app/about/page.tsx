    ...
    <div>
      ...
      <section className="pt-28 pb-20 lg:pb-32 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-white/30 text-xs tracking-[0.3em] uppercase mb-6">Our Story</p>
      ...
      <section className="pb-24 lg:pb-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            {/* Image */}
            <div className="aspect-[4/5] bg-neutral-900 border border-white/5 flex items-center justify-center order-2 lg:order-1">
              <span className="text-white/20 text-xs tracking-wider">BRAND IMAGE</span>
            </div>
            {/* Text */}
            <div className="order-1 lg:order-2">
              <h2 className="text-2xl md:text-3xl font-light tracking-wider text-white mb-8">
                Born From Passion
              </h2>
      ...
      <section className="py-24 lg:py-32 bg-neutral-950 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-white/30 text-xs tracking-[0.3em] uppercase mb-4">What We Stand For</p>
            <h2 className="text-3xl md:text-4xl font-light tracking-wider text-white">Our Values</h2>
            <div className="w-12 h-px bg-white/20 mx-auto mt-6" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <h3 className="text-white text-lg tracking-wider font-light mb-4">Quality</h3>
            ...
            <div className="text-center">
              <h3 className="text-white text-lg tracking-wider font-light mb-4">Authenticity</h3>
              <p className="text-white/30 text-sm leading-relaxed">
            ...
            <div className="text-center">
              <h3 className="text-white text-lg tracking-wider font-light mb-4">Service</h3>
              <p className="text-white/30 text-sm leading-relaxed">
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          <p className="text-white/30 text-xs tracking-[0.3em] uppercase mb-6">Our Promise</p>
          <h2 className="text-2xl md:text-4xl font-light tracking-wider text-white mb-8 leading-relaxed">
