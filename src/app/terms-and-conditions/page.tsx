    ...
    <div className="pt-28 pb-20 px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-4xl font-light tracking-wider text-black">Terms &amp; Conditions</h1>
          <div className="w-12 h-px bg-black/25 mx-auto mt-6" />
        </div>

        <div className="space-y-10 text-black/65 text-sm leading-relaxed">
          <section>
            <h2 className="text-black text-lg tracking-wider font-medium mb-4">General</h2>
            <p>
          ...
          <section>
            <h2 className="text-black text-lg tracking-wider font-medium mb-4">Products</h2>
            <p>
          ...
          <section>
            <h2 className="text-black text-lg tracking-wider font-medium mb-4">Pricing</h2>
            <p>
          ...
          <section>
            <h2 className="text-black text-lg tracking-wider font-medium mb-4">Orders</h2>
            <p>
          ...
          <section>
            <h2 className="text-black text-lg tracking-wider font-medium mb-4">Delivery</h2>
            <p>
          ...
          <section>
            <h2 className="text-black text-lg tracking-wider font-medium mb-4">Payment</h2>
            <p>
          ...
          <section>
            <h2 className="text-black text-lg tracking-wider font-medium mb-4">Contact</h2>
            <p>
