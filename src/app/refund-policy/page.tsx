    ...
    <div className="pt-28 pb-20 px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-4xl font-light tracking-wider text-white">Refund Policy</h1>
          <div className="w-12 h-px bg-white/20 mx-auto mt-6" />
        </div>

        <div className="space-y-10 text-white/50 text-sm leading-relaxed">
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Refund Eligibility</h2>
            <p>
              We want you to be completely satisfied with your purchase. If you are not satisfied, you may request a refund within <strong className="text-white/70">3 days of delivery</strong>.
            </p>
          </section>

          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Conditions for Return</h2>
          ...
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">How to Request a Refund</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Refund Process</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Delivery Area</h2>
            <p>
              Please note that delivery is currently available only in <strong className="text-white/70">Karachi</strong>. All deliveries and returns are handled directly by our team.
            </p>
          </section>

          <section>
            <h2 className="text-white text-lg tracking-wider font-light mb-4">Exceptions</h2>
            <p>
