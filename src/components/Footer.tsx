    ...
    <footer className="bg-white border-t border-black/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 flex items-center gap-4">
              <a
                ...
                className="w-9 h-9 rounded-full bg-black flex items-center justify-center hover:bg-black/80 transition-colors duration-300"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-green-600 flex items-center justify-center hover:bg-green-700 transition-colors duration-300"
                aria-label="WhatsApp"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-white">
          ...
          {/* Shop */}
          <div>
            <h4 className="text-black text-xs tracking-[0.2em] uppercase mb-6 font-semibold">Shop</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-black text-xs tracking-[0.2em] uppercase mb-6 font-semibold">Company</h4>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/about"
          ...
          {/* Legal */}
          <div>
            <h4 className="text-black text-xs tracking-[0.2em] uppercase mb-6 font-semibold">Legal</h4>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/privacy-policy"
